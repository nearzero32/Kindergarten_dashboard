...
class Api {
    ...
    async addStudent({ account_name, account_email, account_mobile, account_password, account_password_show, account_birthday, account_address, account_card_number, class_school_id, isAccountDisabled, study_year }) {
        axios.defaults.headers.common.Authorization = localStorage.getItem('accessToken')
        return axios
            .post('/student/add', {
                account_name,
