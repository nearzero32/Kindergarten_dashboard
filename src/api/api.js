...
class Api {
  ...
  // absence
  async getAbsenceStudent(class_school_id, study_year, page, itemsPerPage, search) {
    axios.defaults.headers.common.Authorization = localStorage.getItem('accessToken')
    return axios
      .get(`/absence/student/class_school/${class_school_id}/study_year/${study_year}?page=${page}&limit=${itemsPerPage}&search=${search}`)
      .then(Response => Response)
      .catch(error => {
        console.log('error', error)
