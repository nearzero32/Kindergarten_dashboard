    ...
    <div class="page">
      ...
      <div>
        ...
        <div>
          ...
          <h2 v-if="item.account_mobile2">رقم الهاتف 2: {{ item.account_mobile2 }}</h2>
          <h2 v-if="item.account_mobile3">رقم الهاتف 3: {{ item.account_mobile3 }}</h2>
          <h2 v-if="item.account_mobile4">رقم الهاتف 4: {{ item.account_mobile4 }}</h2>
...
export default {
  ...
  async created() {
    ...
    this.item = JSON.parse(localStorage.getItem('printOneDriver'))
