  ...
  <div class="team">
    <v-container class="indigo lighten-5 my-5">
      <v-card class="white pa-3">
        <h1 class="text-center subtitle-4 black--text"> montessori </h1>
        <v-row class="mt-5">
          <v-col md="3" xs="12">
            <div class="d-md-flex">
              <v-btn tile color="primary" class="ml-2 mb-4 mb-md-0 mb-sm-0" :block="isScreenXs" @click="goToAddPage">
                اضافة montessori <v-icon right style="font-size: 15px"> fa-plus </v-icon>
              </v-btn>
...
export default {
  ...
  methods: {
    async getTeacherDataAxios() {
      ...
      const response = await Api.getNotification({ notificationType: "montessori", startDate: this.tableModifier.startDate, endDate: this.tableModifier.endDate, page: page, limit: itemsPerPage })
    ...
    goToAddPage() {
      this.$router.push('/montessori/addMontessori')
    },
