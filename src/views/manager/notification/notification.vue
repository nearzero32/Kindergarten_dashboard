...
export default {
  ...
  methods: {
    async getTeacherDataAxios() {
      ...
      const response = await Api.getNotification({ notificationType: "اشعارات", startDate: this.tableModifier.startDate, endDate: this.tableModifier.endDate, page: page, limit: itemsPerPage })
