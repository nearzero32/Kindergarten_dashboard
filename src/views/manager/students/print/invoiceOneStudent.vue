        ...
        <div>
          <div class="d-flex align-center">
            <img :src="results.content_url + results.school_logo"
              style="max-height: 100px; max-width: 100px; border-radius: 10%; margin: 0 5px 0 10px;" alt="logo" contain>
...
export default {
  ...
  async created() {
    ...
    this.item = JSON.parse(localStorage.getItem('printOneStudents'))
