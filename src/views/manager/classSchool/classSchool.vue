        ...
        <v-card-text>
          <v-container>
            <v-form v-model="addDialog.isFormValidAdd">
              <v-row>
                <v-col cols="12">
                  <v-text-field v-model="class_data.selectedClass" label="الصف" :rules="addRules.classes_idRules"
        ...
        <v-card-text>
          <v-container>
            <v-form v-model="dialogEdit.isFormValid">
              <v-row>
                <v-col cols="12">
                  <v-text-field v-model="editedItem.class_name" label="الصف" :rules="addRules.classes_idRules" outlined>
                  </v-text-field>
                </v-col>
                <v-col cols="12">
...
export default {
  ...
  methods: {
    ...
    async AddClass() {
      ...
      const response = await Api.addClassSchool(this.class_data.selectedClass, this.class_data.class_school_leader)
