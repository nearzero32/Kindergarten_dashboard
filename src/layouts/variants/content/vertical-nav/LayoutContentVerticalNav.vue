...
import navMenuItems from '@/navigation/vertical/managerDashboard/normal'

// import navMenuItemsNoTeacher from '@/navigation/vertical/managerDashboard/withFeatures/noTeacher'
